...
Main page of the application. \begin{DoxySeeAlso}{See also}
...
Action controller of the servlet. Make methods work when buttons are pressed. $<$ Our writer to type html codes 
